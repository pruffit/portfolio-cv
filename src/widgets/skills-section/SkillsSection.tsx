...
export function SkillsSection() {
  ...
  return (
    <>
      <SEO title="Навыки" titleEn="Skills" path="/" />
                    ...
                    return (
                      ...
                      >
                        <div className="shrink-0">
                          <div
                            className={`size-1.5 rounded-full sm:size-2 ${levelConfig.dotColor}`}
                          />
                        </div>

                        <div className="min-w-0 flex-1">
                          <p className="truncate text-xs font-medium sm:text-sm md:text-base">
                            {skill.name}
                          </p>
                        ...
                        <div className="shrink-0">
                          <span
                            className={`rounded-full px-1.5 py-0.5 text-[9px] font-medium sm:px-2 sm:py-1 sm:text-[10px] md:text-xs ${levelConfig.badgeColor}`}
                          >
