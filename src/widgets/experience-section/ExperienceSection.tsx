...
export function ExperienceSection() {
  ...
  return (
    <>
      <SEO title="Опыт" titleEn="Experience" path="/" />
                                ...
                                {exp.team && (
                                  <div className="mb-6 flex items-center gap-2 text-sm text-muted-foreground">
                                    ...
                                    <span>
                                      ...
                                      {exp.team.designer && `, ${exp.team.designer} UI/UX Designer`}
                                      {exp.team.qa && `, ${exp.team.qa} QA`}
                                      {exp.team.seo && `, ${exp.team.seo} SEO`}
                                      {exp.team.copy && `, ${exp.team.copy} Copywriter`}
                                      {exp.team.project && `, ${exp.team.project} Project Manager`}
                                      {exp.team.product && `, ${exp.team.product} Product Manager`}
                                      {exp.team.lead && `, ${exp.team.lead} Team Lead`}
                                    </span>
                                  </div>
                                )}
